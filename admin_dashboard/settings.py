...
DATABASES = {
    'default': dj_database_url.config(default=os.getenv('DATABASE_URL', 'postgres://postgres:new-lab@123@db:5432/farming_db'))
}
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://redis:6379/1'  # Change from 127.0.0.1 to 'redis' for Docker service name
    }
}
